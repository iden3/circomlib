...
describe("Num2Bits_strict test", function () {
    ...
    before( async() => {
        circuit = await tester(path.join(__dirname, "num2bits_strict.test.circom"));
    });
    ...
    //TODO: What happens when the number is larger than 254 bits?