...
const poseidon = require("../js/poseidon.js");
...
describe("Poseidon Circuit test", function () {
    ...
    before( async () => {
        circuit6 = await tester(path.join(__dirname, "poseidon_6.test.circom"));
        circuit3 = await tester(path.join(__dirname, "poseidon_3.test.circom"));
    });

    it("Should check constraint of hash([1, 2]) t=6", async () => {
    ...
    it("Should check constraint of hash([3, 4]) t=6", async () => {
    ...
    it("Should check constraint of hash([1, 2]) t=3", async () => {
    ...
    it("Should check constraint of hash([3, 4]) t=3", async () => {
