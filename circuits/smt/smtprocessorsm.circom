...
template SMTProcessorSM() {
  ...
  st.new1 <== (aux2 - st.old0 + prev.bot)*xor;
  ...
  st.bot <== (1-xor) * (aux2 - st.old0 + prev.bot);
  ...
  st.na <== prev.new1 + prev.old0 + prev.na + prev.upd;
